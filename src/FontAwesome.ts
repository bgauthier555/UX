...
export enum FontAwesome {
    ...
    FA_FILE_EXCLAMATION = "fa-file-exclamation",
    ...
    FA_FILE_CERTIFICATE = "fa-file-certificate",
    
    FA_FOLDERS = "fa-folders",
    
    FA_LIGHTBULB_EXCLAMATION = "fa-lightbulb-exclamation",
    ...
    FA_BANK = "fa-university",
    
    FA_BAR_CHART = "fa-chart-bar",
    
    FA_BAR_CHART_O = "fa-chart-bar",
    ...
    FA_CALENDAR_CHECK_O = "fa-calendar-check",
    
    FA_CALENDAR_MINUS_O = "fa-calendar-minus",
    
    FA_CALENDAR_O = "fa-calendar",
    
    FA_CALENDAR_PLUS_O = "fa-calendar-plus",
    
    FA_CALENDAR_TIMES_O = "fa-calendar-times",
    ...
    FA_CARET_SQUARE_O_DOWN = "fa-caret-square-down",
    
    FA_CARET_SQUARE_O_LEFT = "fa-caret-square-left",
    
    FA_CARET_SQUARE_O_RIGHT = "fa-caret-square-right",
    
    FA_CARET_SQUARE_O_UP = "fa-caret-square-up",
    ...
    FA_CHECK_CIRCLE_O = "fa-check-circle",
    
    FA_CHECK_SQUARE = "fa-check-square",
    
    FA_CHECK_SQUARE_O = "fa-check-square",
    ...
    FA_CIRCLE_O = "fa-circle",
    
    FA_CIRCLE_O_NOTCH = "fa-circle-notch",
    ...
    FA_COMMENT_O = "fa-comment",
    
    FA_COMMENTING = "fa-commenting",
    
    FA_COMMENTING_O = "fa-commenting",
    
    FA_COMMENTS = "fa-comments",
    
    FA_COMMENTS_O = "fa-comments",
    ...
    FA_DOLLAR = "fa-usd-square",
    
    FA_DOT_CIRCLE_O = "fa-dot-circle",
    ...
    FA_ENVELOPE_O = "fa-envelope",
    
    FA_ENVELOPE_SQUARE = "fa-envelope-square",
    
    FA_ERASER = "fal fa-eraser",
    ...
    FA_FILE_MINUS = "fa-file-minus",
    
    FA_FILE_INVOICE = "fa-file-invoice",
    
    FA_FILE_ARCHIVE_O = "fa-file-archive",
    
    FA_FILE_AUDIO_O = "fa-file-audio",
    
    FA_FILE_CODE_O = "fa-file-code",
    
    FA_FILE_EXCEL_O = "fa-file-excel",
    
    FA_FILE_IMAGE_O = "fa-file-image",
    
    FA_FILE_MOVIE_O = "fa-file-movie",
    
    FA_FILE_O = "fa-file",
    
    FA_FILE_PDF_O = "fa-file-pdf",
    
    FA_FILE_PHOTO_O = "fa-file-photo",
    
    FA_FILE_PICTURE_O = "fa-file-picture",
    
    FA_FILE_POWERPOINT_O = "fa-file-powerpoint",
    
    FA_FILE_SOUND_O = "fa-file-sound",
    
    FA_FILE_TEXT = "fa-file-alt",
    
    FA_FILE_TEXT_O = "fa-file-alt",
    
    FA_FILE_VIDEO_O = "fa-file-video",
    
    FA_FILE_WORD_O = "fa-file-word",
    
    FA_FILE_ZIP_O = "fa-file-zip",
    ...
    FA_FOLDER_O = "fa-folder",
    
    FA_FOLDER_OPEN = "fa-folder-open",
    
    FA_FOLDER_OPEN_O = "fa-folder-open",
    ...
    FA_HAND_GRAB_O = "fa-hand-grab",
    
    FA_HAND_LIZARD_O = "fa-hand-lizard",
    ...
    FA_HAND_PAPER_O = "fa-hand-paper",
    
    FA_HAND_PEACE_O = "fa-hand-peace",
    
    FA_HAND_POINTER_O = "fa-hand-pointer",
    
    FA_HAND_ROCK_O = "fa-hand-rock",
    
    FA_HAND_SCISSORS_O = "fa-hand-scissors",
    
    FA_HAND_SPOCK_O = "fa-hand-spock",
    
    FA_HAND_STOP_O = "fa-hand-stop",
    ...
    FA_LIGHTBULB_O = "fa-lightbulb",
    
    FA_LINE_CHART = "fa-chart-bar",
    ...
    FA_MINUS_SQUARE_O = "fa-minus-square",
    
    FA_MOBILE = "fa-mobile",
    
    FA_MOBILE_PHONE = "fa-mobile-phone",
    
    FA_MONEY = "fa-money-bill",
    ...
    FA_PAPER_PLANE_O = "fa-paper-plane",
    ...
    FA_PENCIL_SQUARE_O = "fa-pencil-square",
    ...
    FA_PICTURE_O = "fa-image",
    
    FA_PIE_CHART = "fa-chart-pie",
    ...
    FA_PLAY_CIRCLE_O = "fa-play-circle",
    ...
    FA_PLUS_SQUARE_O = "fa-plus-square",
    ...
    FA_SHARE_SQUARE_O = "fa-share-square",
    ...
    FA_SOCCER_BALL_O = "fa-soccer-ball",
    ...
    FA_STICKY_NOTE_O = "fa-sticky-note",
    ...
    FA_TIMES_CIRCLE_O = "fa-times-circle",
    ...
    FA_WARNING = "fa-exclamation-triangle",
    ...
    FA_Y_COMBINATOR_SQUARE = "fa-y-combinator-square",
    
    FA_YAHOO = "fa-yahoo",
    
    FA_YC = "fa-yc",
    
    FA_YC_SQUARE = "fa-yc-square",
    ...
    FA_DRIVERS_LICENCE_O = "fa-id-card",
    
    FA_ADDRESS_CARD_O = "fa-address-card",
